...
-- PACKAGE BODY
CREATE OR REPLACE PACKAGE BODY PK_GENERAL AS
    PROCEDURE P_REGISTRAR_CLIENTE (
        P_NOMBRE           IN     VARCHAR2,
        P_APELLIDO1        IN     VARCHAR2,
        P_APELLIDO2        IN     VARCHAR2,
...
CREATE OR REPLACE PUBLIC SYNONYM PK_GENERAL FOR indra.PK_GENERAL;
GRANT EXECUTE ON PK_GENERAL TO PUBLIC;
